#!/bin/bash
# Resolve the MyCS bastion/node image name for node-builder Docker builds.
#
# Usage:
#   ./apps/clients/node-builder/scripts/get-cloud-image.sh       # local CLI → mycs-node-image_dev
#   ./apps/clients/node-builder/scripts/get-cloud-image.sh dev   # local CLI → mycs-node-image_dev
#   ./apps/clients/node-builder/scripts/get-cloud-image.sh ci    # latest GH Actions D.* AMI
#   ./apps/clients/node-builder/scripts/get-cloud-image.sh prod  # latest mycs-node-image_X.Y.Z
#
