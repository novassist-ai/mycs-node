...
from node_builder.cloud.nodes import get_node_state, list_nodes, parse_node_from_output
...
def test_get_node_state_vagrant_vbox(monkeypatch) -> None:
    ...
    monkeypatch.setattr("node_builder.cloud.nodes.run_cmd", fake_run)
...
def test_start_stop_vagrant_vbox(monkeypatch) -> None:
    ...
    monkeypatch.setattr("node_builder.cloud.power.run_cmd", fake_run)
    session = CloudSession()
