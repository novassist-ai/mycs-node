...
from node_builder.cloud.regions import list_regions, validate_region
...
def test_list_and_validate_aws_regions(monkeypatch) -> None:
    ...
    monkeypatch.setattr("node_builder.cloud.regions.run_cmd", fake_run)
    ...
    with pytest.raises(NodeBuilderError, match="Unknown aws region"):
