...
from node_builder.core.eula import is_eula_accepted
from node_builder.core.paths import PathContext, resolve_paths
...
def doctor() -> None:
    ...
    console.print("[bold]node-builder doctor[/bold]")
