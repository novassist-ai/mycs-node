...
def list_regions(
    ...
    *,
    ...
    raise VpnNodeBuilderError(f'Cloud "{cloud}" does not use regions.')
...
def validate_region(
    ...
    *,
    ...
    if region not in regions:
        raise VpnNodeBuilderError(f'Unknown {cloud} region "{region}".')
...
def first_zone_for_region(
    ...
    *,
    ...
    if not matched:
        raise VpnNodeBuilderError(f'No Google Cloud zones found for region "{region}".')
    return matched[0]
