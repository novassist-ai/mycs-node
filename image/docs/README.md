...
| Document | Topics |
|----------|--------|
| [network-design.md](network-design.md) | netplan, nftables, NAT, forwarding, Docker bypass, VPN gateway NAT, network troubleshooting |
| [ipsec-vpn-connectivity-design.md](ipsec-vpn-connectivity-design.md) | Road-warrior + VPN gateway interaction |
