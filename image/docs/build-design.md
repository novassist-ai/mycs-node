...
| `publish-qcow2-image.sh` | Upload qcow2 to `novassist-public` + latest redirect | — | — | — |
| `delete-qcow2-images.sh` | List/delete qcow2 objects under S3 channel/arch prefix | — | — | — |
...
Primary manifests are HCL (`packer/*.pkr.hcl`).
