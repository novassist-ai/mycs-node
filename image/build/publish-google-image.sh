...
IMAGE_OBJECT_NAME="appbricks-bastion_$1"
REGION="${2:-all}"
...
function google::publish_image_object() {
  ...
  gsutil cp \
    "gs://${SOURCE_BUCKET}/appbricks-bastion/${IMAGE_OBJECT_NAME}.tar.gz" \
    "gs://${publish_bucket}/appbricks-bastion/${IMAGE_OBJECT_NAME}.tar.gz"
}
